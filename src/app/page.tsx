      ...
      <div className="max-w-7xl mx-auto p-6 md:p-12 space-y-12">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl font-black text-primary">Hey, {MOCK_USER.name}!</h1>
          ...
          <div className="flex gap-4">
            <Card className="flex items-center gap-3 px-5 py-3 rounded-2xl border-none shadow-lg bg-white">
              ...
              <div>
                ...
                <p className="text-xl font-black text-orange-600">{MOCK_USER.streak} Days</p>
              </div>
            </Card>
            ...
            <Card className="flex items-center gap-3 px-5 py-3 rounded-2xl border-none shadow-lg bg-white">
              ...
              <div>
                ...
                <p className="text-xl font-black text-yellow-600">#{MOCK_USER.rank}</p>
              </div>
            </Card>
          </div>
        </header>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <TrackCard type="Fitness" currentStage={MOCK_USER.trackProgress.Fitness.currentStage} totalStages={30} />
            <TrackCard type="Nutrition" currentStage={MOCK_USER.trackProgress.Nutrition.currentStage} totalStages={30} />
            <TrackCard type="Behavior" currentStage={MOCK_USER.trackProgress.Behavior.currentStage} totalStages={30} />
            <TrackCard type="Study" currentStage={MOCK_USER.trackProgress.Study.currentStage} totalStages={30} />
          </div>
        </section>
