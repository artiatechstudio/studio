              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="terms-rules">
                  ...
                  <AccordionContent className="text-right font-bold text-muted-foreground leading-relaxed text-sm space-y-4">
                    ...
                    <p>● <span className="text-primary font-black">النقاط والحماسة:</span> النظام يعتمد على مبدأ الالتزام الشخصي. أي تلاعب في إكمال المهام يضر بمصداقية سجل إنجازاتك. (من غشنا فليس منا)</p>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
