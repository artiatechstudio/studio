...
const MESSAGES = [
  ...
  "النمو يحتاج صبراً، وأنت تملك الكثير منه! 🐱",
  "أنت تصنع فرقاً حقيقياً في حياتك كل يوم.",
  "الحياة رحلة، وكارينجو هو بوصلتك للنجاح.",
  "فخور جداً بكل إنجاز تحققه، حتى لو كان صغيراً."
];
