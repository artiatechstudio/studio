...
// --- التحديات الأصلية للمسارات (30 يوم) ---
...
// --- الـ 120 تحدي الإضافية الحصرية للماستر ---
...
for (let i = 1; i <= 120; i++) {
  ...
  ADDITIONAL_MASTER_CHALLENGES.push({
    ...
    description: `هذا تحدي عشوائي من المستوى المتقدم لزيادة كفاءتك في مسار ${type === 'Fitness' ? 'اللياقة' : type === 'Nutrition' ? 'تغذية' : type === 'Behavior' ? 'سلوك' : 'دراسة'}. المطلوب هو الاستمرارية والتركيز المطلق لمدة ${time} دقيقة.`,
